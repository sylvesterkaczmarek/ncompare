...
- Keep output colors local to each `Outputter` so overlapping comparisons can use different color settings without changing colorama globals or report alignment ([#366](https://github.com/nasa/ncompare/issues/366)) ([**@sylvesterkaczmarek**](https://github.com/sylvesterkaczmarek)).
